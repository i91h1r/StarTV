...
public abstract class BaseLazyFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isBindRxBusHere()) {
            rxSubscription = RxBus.getDefault().toObservableSticky(EventCenter.class).map(
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if (getContentViewLayoutID() != 0) {
            ...
            if (getRefreshLayoutView() != null) {
                ...
                BGAMeiTuanRefreshViewHolder bgaMeiTuanRefreshViewHolder
                    = new BGAMeiTuanRefreshViewHolder(mContext, true);

                initRefreshLayout(bgaMeiTuanRefreshViewHolder);
    ...
    protected abstract void initRefreshLayout(BGAMeiTuanRefreshViewHolder bgaMeiTuanRefreshViewHolder);
